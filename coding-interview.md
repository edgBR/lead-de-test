...
# Lead Data Engineer – Coding Interview

This document outlines the **Coding Interview** portion of the Lead Data Engineer interview exercise.
...
This test is designed to mimic what will be your role. We believe in close collaboration and sometimes we do this asyncronously (via PRs comments etc...) and sometimes syncronously via teams calls or VScode live sessions.
...
Traditionally, we have conducted this stage of the interview process offline. However with the advent of AI-coding assistance this has become unreliable as candidates with more available time, can do much more than others.
...
The driver will have access to GitHub Copilot Business. With the following models available:

- All Claude Models (up to Opus 4.5).
- All Gemini models (up to 3 Pro).
- All GPT models (up to 5.2).
